...
Error CDCDriver::OnEndpointsConfigured() { return MAKE_ERROR(Error::kSuccess); }

Error CDCDriver::OnControlCompleted(EndpointID ep_id, SetupData setup_data, const void *buf,
                                    int len) {
