...
WithError<usb::ClassDriver *> NewClassDriver(std::vector<usb::EndpointConfig> &ep_configs,
                                             usb::Device *dev,
...
Error Device::NormalIn(EndpointID ep_id, void *buf, int len) { return MAKE_ERROR(Error::kSuccess); }
